                          ...
                          child: TypeAheadField(
                              ...
                              onSuggestionSelected: (productlist) {
                                final data = {
                                  ...
                                  "brand_name":
                                      productlist.brandName.toString(),
                                  "generic_id":
                                      productlist.genericId.toString(),
                                  "generic_name":
                                      productlist.genericName.toString(),
                                  "available_qty":
                                      productlist.availableQty.toString(),
                                  "unit_id":
                                      productlist.defaultUnitId.toString(),
                                  "unit_name":
                                                                ...
                                                                onTap:
                                                                  ...
                                                                  if (paymentterm
                                                                    ...
                                                                    if (salesresponse["status"]
                                                                        ...
                                                                        "success") {
                                                                      if (printneeded) {
                                                                        final Map<String, dynamic> response = await API.getInvoicesDetailsByIDAPI(
                                                                        ...
                                                                        if (response
                                                                          ...
                                                                          final dynamic
                                                                              ...
                                                                              await API.getPrinterDetails();
                                                                          if (printerdetailsresponse["status"] ==
                                                                              "success") {
                                                                            printerManager.selectPrinter(PrinterBluetooth(bt.BluetoothDevice.fromJson({
                                                                              "name": printerdetailsresponse["btname"].toString(),
                                                                              "address": printerdetailsresponse["btaddress"].toString()
                                                                            })));
                                                                            const PaperSize
                                                                                paper =
                                                                                PaperSize.mm80;
                                                                            ...
                                                                            final PosPrintResult
                                                                              ...
                                                                              profile,
                                                                              {
                                                                                "company_name": widget.userdetails["companyname"].toString(),
                                                                                "company_address": widget.userdetails["companyaddress"].toString(),
                                                                                "company_phone": widget.userdetails["companyphone"].toString(),
                                                                                "company_trn": widget.userdetails["companytrn"].toString(),
                                                                                "invoice_no": response["invoice_no"].toString(),
                                                                                "invoice_date": response["invoice_created_date_time"].toString(),
                                                                                "customer_name": response["customer_name"].toString(),
                                                                                "customer_trn_no": response["customer_trn"].toString(),
                                                                                "salesman": response["sales_man"].toString(),
                                                                                "invoice_item_list": response["invoice_item_list"],
                                                                                "total_amount": num.parse(response["sub_total"].toString()).toStringAsFixed(2),
                                                                                "tax_total": num.parse(response["vat_amount"].toString()).toStringAsFixed(2),
                                                                                "grand_total": num.parse(response["grand_total"].toString()).toStringAsFixed(2),
                                                                                "payment_type": response["payment_term_name"].toString()
                                                                              },
                                                                            )));
                                                                            pushWidgetWhileRemove(
                                                                                newPage: const SuccessPage(screen: CustomDrawerScreen()),
                                                                                context: context);
                                                                          } else {
                                                                            setSheetState(() {
                                                                              sheetloading = false;
